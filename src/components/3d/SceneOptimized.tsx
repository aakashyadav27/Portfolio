...
/**
 * Optimized Scene - Uses compressed 3D assets (96% smaller)
 *
 * Original assets: ~235MB total
 * Optimized assets: ~9.3MB total (96% reduction)
 *
 * To test: Replace Scene with SceneOptimized in your page
 */
  ...
  return (
    ...
    >
      <div style={{ color: "#00ff00", fontSize: "18px", marginBottom: "20px" }}>
        AAKASH PORTFOLIO BIOS v2.0 (OPTIMIZED)
      </div>
...
export function SceneOptimized({
